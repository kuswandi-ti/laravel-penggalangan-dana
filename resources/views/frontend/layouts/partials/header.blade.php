            ...
            <div class="flex-wrap col-lg-3 col-12 d-flex justify-content-center">
                <ul class="social-icon">
                    <li class="social-icon-item">
                        <a href="{{ $setting->youtube_link }}" class="social-icon-link bi-youtube" target="_blank"></a>
                    </li>
                    <li class="social-icon-item">
                        <a href="{{ $setting->fanpage_link }}" class="social-icon-link bi-facebook" target="_blank"></a>
                    </li>
                    <li class="social-icon-item">
                    ...
                    <li class="social-icon-item">
                        <a href="{{ $setting->twitter_link }}" class="social-icon-link bi-twitter" target="_blank"></a>
                    </li>
                    <li class="social-icon-item">
                    ...
                    <li class="social-icon-item">
                        <a href="https://wa.me/{{ !empty($setting->phone) ? $setting->phone : '' }}"
                            class="social-icon-link bi-whatsapp" target="_blank"></a>
                    </li>
                </ul>
            </div>
